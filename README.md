...
This command tells devtap to start capturing your build or development output and share it with the Codex AI coding model. Replace “codex” with the AI assistant you use.
